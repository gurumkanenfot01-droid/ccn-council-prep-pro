  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        minutes: 12,
        overview:
          'A focused look at Mercor specifically, since it comes up constantly in this space. Mercor is a talent marketplace that vets professionals and matches them to project-based work for AI labs and companies — data and model evaluation, domain-expert consultation, and technical assessment work. This lesson covers the shape of how it works; treat Mercor\'s own site as the authority on anything specific.',
        steps: [
          'Understand the core model: you apply and get vetted once, then get matched to individual paid projects as they become available — you\'re not applying to one fixed job.',
          'Learn that project availability depends on current client demand in your specific skill area, so matching can be near-immediate or take time depending on your domain and how much work Mercor\'s clients currently need in it.',
          'Note that most engagements are structured as contract/freelance work rather than traditional salaried employment — read the actual agreement Mercor presents for the specific engagement you\'re offered, since terms can vary by project.',
          'Create your account directly on Mercor\'s own site and read their current FAQ/help content before applying — it overrides anything general written here if the two ever disagree.',
        ],
        takeaways: [
        ...
        resources: ['Mercor Official Site (confirm current URL yourself)'],
      },
      {
        id: 'l1c',
        title: 'Mercor Task Categories You Can Qualify For',
        minutes: 10,
        overview:
          'Mercor routes vetted candidates into different work categories based on their background. Knowing the categories lets you position your application correctly instead of applying generically and hoping.',
        steps: [
          'Technical/coding evaluation: reviewing, rating, or writing test cases against AI-generated code — the best fit if you have a software engineering background.',
          'Domain-expert review: verifying AI outputs in a specific professional field such as law, medicine, finance, or science — the best fit if you hold real credentials or years of practice in that field.',
          'General writing & reasoning evaluation: rating and improving AI response quality on open-ended tasks — the best fit if you have strong writing, research, or teaching experience.',
          'Specialized or multilingual work: language-specific evaluation or translation-adjacent tasks — the best fit if you\'re fluent in a language beyond English.',
        ...
        takeaways: [
          ...
          'Category names and availability shift over time — check Mercor\'s current site for what\'s actually open before assuming a category still exists as described here.',
        ],
      },
      {
        id: 'l1d',
        ...
        minutes: 13,
        overview:
          'A step-by-step walkthrough of the general shape of Mercor\'s application process, based on how vetted marketplaces in this space typically operate. Confirm each step against Mercor\'s current flow as you go — exact screens and requirements change.',
        steps: [
          'Step 1 — Create your account and complete your profile fully (see "Building a Profile That Gets Matched" for the detailed checklist).',
          'Step 2 — Upload your CV using the skills-first format from the CV lesson, tailored to the task category you picked.',
          'Step 3 — Complete any initial screening questions honestly and specifically — vague answers are the most common reason strong candidates get filtered out early.',
          'Step 4 — Complete a skills assessment for your chosen category if one is presented, using the approach from "Acing the Skills Assessment."',
          'Step 5 — Wait for matching. Because Mercor is demand-driven, being approved doesn\'t always mean instant project access — keep your profile current while you wait.',
          'Step 6 — When matched to a project, read the specific project brief and terms carefully before accepting — pay, hours, and duration vary project to project.',
        ...
        takeaways: [
          ...
          'Your first project\'s early output quality tends to matter more than anything that comes after it for whether you keep getting matched.',
        ],
        resources: ['Application Tracker Template'],
      },
      {
        id: 'l1e',
        title: 'Mercor Interview & Assessment Guide',
        minutes: 11,
        overview:
          'Mercor-specific prep layered on top of the general "Interview Playbook" lesson — what to actually do differently when the platform in front of you is Mercor.',
        steps: [
          'Expect assessments to be closely tied to the specific task category you\'re applying for — a coding assessment looks and feels different from a writing/reasoning one, so don\'t prep generically.',
          'Time-box your assessment prep the same way you would the real thing — most vetted-marketplace assessments are timed, and rushing at the end costs more accuracy than going in slightly under-practiced.',
          'If a live interview stage is presented, prepare to explain your reasoning on a sample evaluation task out loud, not just give a final answer — the "why" is usually what\'s actually being scored.',
          'If you\'re not matched or don\'t pass on a first attempt, look for a stated reapplication or retake window on Mercor\'s own site rather than assuming it\'s permanent.',
          'Keep a personal note of what you were asked and how you answered right after any interview — it\'s the fastest way to improve if you try again.',
        ],
        takeaways: [
          'Mercor\'s process rewards category-specific preparation over generic "AI training" prep.',
          'A rejection or failed assessment is usually a "not yet," not a "never" — check the platform\'s own retake policy before writing it off.',
        ],
      },
      {
        id: 'l2',
